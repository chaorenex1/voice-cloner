...
pub fn run() {
    ...
    let builder = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            tauri_api::voice_separation_commands::check_voice_separation_runtime,
            tauri_api::voice_separation_commands::create_voice_separation_job,
            tauri_api::voice_separation_commands::start_voice_separation_job,
            tauri_api::voice_separation_commands::get_voice_separation_job,
            tauri_api::voice_separation_commands::list_voice_separation_jobs,
            tauri_api::voice_separation_commands::cancel_voice_separation_job,
            tauri_api::voice_separation_commands::delete_voice_separation_job,
            tauri_api::voice_separation_commands::preview_voice_separation_stem,
            tauri_api::voice_separation_commands::stop_voice_separation_preview,
            tauri_api::voice_separation_commands::download_voice_separation_stem,
            tauri_api::voice_separation_commands::transcribe_separated_vocals,
            tauri_api::voice_separation_commands::save_separated_vocals_as_custom_voice,
